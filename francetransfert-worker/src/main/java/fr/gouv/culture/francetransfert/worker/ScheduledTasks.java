...
//	}
	...
	public void appSyncGlimpsCheck() {
		LOGGER.info("Worker : start Application synchronization appSyncHealthcheck");
		appSyncServices.appSyncGlimpsCheck();
		LOGGER.info("Worker : finished Application synchronization appSyncHealthcheck");
	}
...
//							}
							...
							// Sleep 60s
							Thread.currentThread().sleep(queueSleep);
						}
					} catch (Exception e) {
